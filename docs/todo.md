...
78. [ ] Add strict-violation reason-token tests verifying malformed-UTF-8 diagnostics take precedence over non-ASCII Unicode-control diagnostics when both checks are enabled.
