...
57. Add strict-violation decode option to emit dedicated diagnostics for mixed-order UTF-16 surrogate sequences (low-before-high) encoded via CESU-8 in defensive canonical-token mode.
