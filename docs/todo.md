...
60. Add strict-violation surrogate-token tests verifying canonical reason-name tokens are accepted when all lone/paired/mixed-order/same-order CESU-8 rejection modes are enabled together.
