...
56. Add strict-violation decode option to emit dedicated diagnostics for paired UTF-16 surrogate sequences encoded via CESU-8 in defensive canonical-token mode.
