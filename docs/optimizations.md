...
| Change | Status | Evidence |
| --- | --- | --- |
| Reuse optimized batch for moving circles with padded bounds + cached command counts | Kept | 20-run mean 88.53 FPS vs 78.67 baseline (~12.5% win) using `--reuse-optimized`. |
